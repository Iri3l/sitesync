...
import { StockEditForm } from "@/components/stock-edit-form"
import { StockOutForm } from "@/components/stock-out-form"
import { StockViewForm } from "@/components/stock-view-form"
...
export default async function StockItemPage({
  ...
  return (
    <div className="space-y-8">
      ...
      {isUser ? (
        <StockViewForm stockItem={stockItem} />
      ) : (
        <div className="grid gap-4 md:grid-cols-2">
          ...
          {isManager && (
            <StockEditForm stockItem={stockItem} />
          )}

          {isSupervisor && (
            <StockOutForm stockItem={stockItem} />
          )}
        </div>
      )}
