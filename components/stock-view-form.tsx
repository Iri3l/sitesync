...
export function StockViewForm({ stockItem, showViewOnlyBanner = true }: { stockItem: StockItem; showViewOnlyBanner?: boolean }) {
  return (
      ...
      {showViewOnlyBanner && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600">You can view this stock item but cannot make changes.</p>
          </div>
        </div>
      )}
